...
INSTALLED_APPS = [
    ...
    'apps.assign_tree',
    'apps.bank_account',
    'apps.career_commission',
    'apps.convert_product',
    'apps.group_commissions',
    'apps.infomation',
    'apps.KYC',
    'apps.library',
    'apps.mutual_commissions',
    'apps.policy_commission',
    'apps.policy_insurance',
    'apps.recruitment_commission',
    'apps.retail_commission',
    'apps.support',
    'apps.tree_binary',
    'apps.tree_mlm',
    'apps.wallet',
    'apps.welfare_commission',
]
...
VNROBOT_API_KEY = "17747EF9CEE01B5CB6DDA018E71123123"